...
namespace OpenUtau.Core.Ustx {
    ...
    [Flags] public enum USingerType { Classic = 0x1, Enunu = 0x2, Vogen = 0x4, DiffSinger = 0x5, Voicevox = 0x6, Custom = 0x8 }
